...
Отправляем пакет на порт 22 с флaгом SYN, получаем ответ SYN-ACK, соединение разрывается.
...
Отправляем пакет на порт с  флагом FIN, ответ не получаем.

![screen](screenshots/ws_sF.png)
